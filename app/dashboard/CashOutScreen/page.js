...
// This is the Cash Out Screen page
// This page will display the table of items to be cashed out at the end of the day
// The user will be able to edit the count of the items
// The user will be able to see the total sales for the day
// The user will be able to see the total stock used for the day

//TO DO: Add the ability  calculate the cash out along with tips
//TO DO:add transaction table to referace for the cashout table
//To DO  Figure out why the Edit Count functions are not working !!!
...
import HSpliter from '../components/HSpliter';
...
function CashOutPg() {
  ...
  // Update the table data to include the new column for ounces sold
  useEffect(() => {
    const updatedTableData = tableData.map((row) => calculateOuncesSold(row));
  ...
  return (
    <div>
      <div className=' flex flex-row w-full items-end'>
        {/* Talk to nathan about how to make useEffect Dominos into a single useEffect then use The searchedBarista state to search for Username Variable  */}
        <input
          placeholder='search BarTenders'
          className='input input-bordered'
          onChange={(e) => setSearchedBarista(e.target.value)}
        />
